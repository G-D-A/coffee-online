...
beforeAll(async () => {
    ...
    // Create products
    const product1 = await MenuModel.create({ name: 'Product 1', price: 50, description: 'Desc 1' });
    const product2 = await MenuModel.create({ name: 'Product 2', price: 30, description: 'Desc 2' });
