...
beforeAll(async () => {
    ...
    await user_model_1.UserModel.updateOne({ email: userData.email }, { $set: { role: 'admin' } });
...
afterEach(async () => {
    await product_model_1.MenuModel.deleteMany({});
});
describe('Menu Routes', () => {
    ...
    it('should list all products', async () => {
        await product_model_1.MenuModel.create({ name: 'P1', price: 10, description: 'D1' });
        const res = await (0, supertest_1.default)(app_1.default)
            .get('/api/menu');
    ...
    it('should get product details', async () => {
        const product = await product_model_1.MenuModel.create({ name: 'Detail Product', price: 50, description: 'Detailed' });
        const res = await (0, supertest_1.default)(app_1.default)
    ...
    it('should update a product', async () => {
        const product = await product_model_1.MenuModel.create({ name: 'Old', price: 20, description: 'Old desc' });
        const res = await (0, supertest_1.default)(app_1.default)
    ...
    it('should delete a product', async () => {
        const product = await product_model_1.MenuModel.create({ name: 'To Delete', price: 15, description: 'X' });
        const res = await (0, supertest_1.default)(app_1.default)
